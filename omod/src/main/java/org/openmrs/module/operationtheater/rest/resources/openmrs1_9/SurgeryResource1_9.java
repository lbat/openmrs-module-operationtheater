...
@Resource(name = RestConstants.VERSION_1 + OperationTheaterRestController.OPERATION_THEATER_REST_NAMESPACE + "/surgery", supportedClass = Surgery.class, supportedOpenmrsVersions = "1.9.*")
